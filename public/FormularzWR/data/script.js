$(document).ready(function() {
	...
	$("#komentarz").text("dziaÅ‚a aaaaaaaaaaaaaaaaa");
...
function remove_object() {
	...
	// alert("dÅ‚ " + $("#list_of_objects").find("tr").length );
...
// oraz Å‚aduje protokol (tabeli z pliku do div -Ã³w)
